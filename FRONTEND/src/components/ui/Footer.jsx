    ...
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3 md:gap-8 py-10 max-sm:max-w-sm max-sm:mx-auto gap-y-8">
            <div className="col-span-full mb-10 lg:col-span-2 lg:mb-0">
                <a href="https://santhosh.devxnet.cloud/"  className="flex justify-center lg:justify-start">
                <img src="https://discordbanners.vercel.app/static/img/logo.svg" alt="logo" />
                </a>
                <p className="py-8 text-sm text-gray-500 lg:max-w-xs text-center lg:text-left">Trusted and Empowering innovation, one solution at a time.. Have any query ?</p>
            ...
            <div className="lg:mx-auto text-left ">
                ...
                <ul className="text-sm  transition-all duration-500">
                    ...
                    <li className="mb-6"><a href="javascript:;"  className=" text-gray-600 hover:text-gray-900">Category</a></li>
            ...
            <div className="lg:mx-auto text-left ">
                ...
                <ul className="text-sm  transition-all duration-500">
                    ...
                    <lpi><a href="javascript:;"  className=" text-gray-600 hover:text-gray-900">Components Library</a></lpi>
                </ul>
            </div>
            <div className="lg:mx-auto text-left">
        ...
        <div className="py-7 border-t border-gray-200">
            <div className="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
                <span className="text-sm text-gray-500 ">©<a href="https://santhosh.devxnet.cloud/">StackOps</a> 2025, All rights reserved.</span>
